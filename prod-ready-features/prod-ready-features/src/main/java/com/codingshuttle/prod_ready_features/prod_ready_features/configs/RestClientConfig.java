package com.codingshuttle.prod_ready_features.prod_ready_features.configs;
...
public class RestClientConfig {
    ...
    @Bean
    @Qualifier("employeeRestClient") // used to differentiate between different rest client
